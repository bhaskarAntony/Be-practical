...
<div className="services container">
    ...
    <p className="p-light-small text-center pb-4">We are providing best services <br /> what you want to reach you software goal</p>
    <div className="row">
