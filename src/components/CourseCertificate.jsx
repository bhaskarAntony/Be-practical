                ...
                <div className="col-md-12 col-12 col-lg-6">
                  <div className="">
                      <div className="course-certification mb-3">
                        ...
                        <div className='fs-5 text-secondary' dangerouslySetInnerHTML={{ __html: data.certification}} />
                      </div>
                      <div className="course-for mb-3">
                        <h3 className="fs-3 mb-2 text-main-danger text-900">Who This Course For</h3>
                        <div className='fs-5 text-secondary' dangerouslySetInnerHTML={{ __html: data.courseFor}} />
                      </div>
                  </div>
                  </div>
            </div>
