...
<div>
<button variant="primary" onClick={handleShow} className='bg-danger-2 btn d-xl-none'>
  <i class="bi bi-list text-white"></i>
  </button>
  <button variant="primary" onClick={handleShowContact} className='btn bg-gray2 mx-2 rounded-2 d-xl-none'>
        ...
        <ul className=' m-0 list-group'>
          ...
          item.subCourses.length !== 0 && (
            item.subCourses.map((subItem, index) => (
              <li key={index} className="mobile-list-item  list-group-item p-2">
  ...
  <ul class="dropdown-menu p-0">
    ...
    <li class="nav-item dropend list-group-item p-0">
      ...
      <ul class="dropdown-menu list-group">
        <li className='list-group-item'><a class="nav-link" href="/mern-fullstack">Advanced CloudOops</a></li>
