          ...
          <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 list-group d-flex align-items-center justify-content-center w-100">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li className="list-group-item">
                    <Link to="https://www.be-practicalhr.com/corporate-training-in-bangalore/" className="nav-link">Corporate Training</Link>
                  </li>
                  <li className="list-group-item">
                    <Link to="https://www.be-practicalhr.com/" className="nav-link">HR Services</Link>
                  </li>
                  <li className="list-group-item">
                    <Link to="/contacts" className="nav-link">Hire Trained Graduates</Link>
                  </li>
                </ul>
              </li>
            </ul>
