...
import { fullstack } from '../../Data/DataFetcher';
...
function FullstackCourse() {
    ...
    return (
        <section className='overflow-hidden'>
          ...
          <CourseHero coursename={courseName} coursesubtitle={heroSubtitle} admisionStart={courseData.details.admisionStart} coursePoints={coursePoints} courseData={courseData} brocherLink={BrocherLink} share={handleWhatsappShare}/>
